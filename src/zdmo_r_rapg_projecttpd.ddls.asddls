...
define root view entity ZDMO_R_RAPG_ProjectTPD
  as select from zdmo_rapgen_bod
  composition [0..*] of ZDMO_R_RAPG_LogTPd  as _Log
  composition [0..*] of ZDMO_R_RAPG_NodeTPd as _Node
{
