...
define view entity ZDMO_C_RAPG_NodeTPd
  as projection on ZDMO_R_RAPG_NodeTPd
{
  key NodeUUID,
      RapBoUUID,
      ParentUUID,
      ...
      { name         : 'ZDMO_C_RAPG_NodeTPD' ,  element: 'EntityName' }
       ,
      ...
      ParentDataSource,
      ViewTypeValue,
      @Consumption.valueHelpDefinition: [ {entity: {name: 'ZDMO_I_RAP_GENERATOR_FIELDSD', element: 'field'},
      ...
      _Field   : redirected to composition child ZDMO_C_RAPG_FieldTPd,
      _Project : redirected to parent ZDMO_C_RAPG_ProjectTPd
      //      ,
      //      _Entity
