...
define abstract entity ZDMO_I_RAP_GEN_PARAM_ADD_NODtt
{
  @EndUserText.label : 'Entity Name'
  entity_name        : zdmo_rap_gen_entitynamed;

  @Consumption.valueHelpDefinition: [{ entity:  { name:    'ZDMO_I_RAP_GEN_GET_CDS_VIEWSD',
                                                  element: 'name' }
                                                  ,
...
//  @UI.defaultValue   : #('ELEMENT_OF_REFERENCED_ENTITY:DataSource')
  ...
  parent_data_source : zdmo_rap_gen_entitynamed;
}
