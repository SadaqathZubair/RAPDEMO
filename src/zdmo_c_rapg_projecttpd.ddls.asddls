...
define root view entity ZDMO_C_RAPG_ProjectTPd
  provider contract transactional_query
  as projection on ZDMO_R_RAPG_ProjectTPD
{
  key      RapBoUUID,
...
//           @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZDMO_CL_RAP_GEN_GET_JOB_STATUS'
  ...
  //virtual  RepositoryObjectsExist : abap_boolean,
           ...
           _Log  : redirected to composition child ZDMO_C_RAPG_LogTPd,
           _Node : redirected to composition child ZDMO_C_RAPG_NodeTPd
