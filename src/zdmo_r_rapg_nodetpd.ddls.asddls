...
define view entity ZDMO_R_RAPG_NodeTPd
  as select from zdmo_rapgen_nodd
  association to parent ZDMO_R_RAPG_ProjectTPd as _Project on $projection.RapBoUUID = _Project.RapBoUUID
  composition [0..*] of ZDMO_R_RAPG_FieldTPd   as _Field
